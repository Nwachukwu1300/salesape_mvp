...
import { createAnalyticsDashboardRouter } from './routes/analytics-dashboard.js';
import { createSchedulingRouter } from './routes/scheduling.js';
import { createApprovalWorkflowRouter } from './routes/approval-workflow.js';
import { createTeamPermissionsRouter } from './routes/team-permissions.js';
...
app.use(createAnalyticsDashboardRouter(authenticateToken));
app.use(createSchedulingRouter(authenticateToken));
app.use(createApprovalWorkflowRouter(authenticateToken));
app.use(createTeamPermissionsRouter(authenticateToken));
export default app;
